...
robot = world.scene.add(Robot(prim_path="/World/ArmTuned", name="robot"))
...
# python c:\Users\krasi\Downloads\simple_case.py --usd_path=c:\IsaacSim\MyScripts\ignored_mimic_upside_down.usd